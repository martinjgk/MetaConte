...
public class NPCManager : MonoBehaviour
{
    ...
    void InitializeInfos()
    {
        ...
        infos.Add(new NPCInfo() { npcNo = 1, npcName = "온 [스승님의 조수]", npcType = "sign", content = "안녕? 이제야 정신이 들었나보구나. 나는 스승님의 조수 온 이라고 해! 비록 스승님은.. 흑흑ㅠㅠ 스승님은 지키지 못했다만, 기절한 너를 끌고 생명의 요람, 물의 왕국으로 겨우 도망쳤어! 물의 왕국은 먼 과거 토끼와 거북이가 방문했다고 알려져 있지엉~\n물의 왕국 주민들 도움이 없었다면, 우리는 분명 괴물에게 잡아먹히고 말았을 것이야! 우리를 대표해서 물의 왕국 주민에게 감사 인사를 전해주고 와볼래?\n [신규 퀘스트] 물의 길: 물의 왕국 주민 쿠아쿠아에게 가까이 다가가 감사 인사를 전해주기.\n게임 진행 방법 설명! 이동: 화면 중앙에 있는 이동 버튼을 클릭. 게임 진행에 필요한 메뉴(ON/OFF): 손바닥이 위로 향하게 왼손을 펴고, 엄지와 검지를 짧게 맞닿아 클릭하기", target = "" });
        infos.Add(new NPCInfo() { npcNo = 2, npcName = "온 [스승님의 조수]", npcType = "sign", content = "우리를 대표해서 물의 왕국 주민에게 감사 인사를 전해주고 와볼래?\n [현재 퀘스트] 물의 길: 물의 왕국 주민 쿠아쿠아에게 가까이 다가가 감사 인사를 전해주기\n게임 진행 방법 설명! 이동: 화면 중앙에 있는 이동 버튼을 클릭. 게임 진행에 필요한 메뉴(ON/OFF): 손바닥이 위로 향하게 왼손을 펴고, 엄지와 검지를 짧게 맞닿아 클릭하기.", target = "" });
